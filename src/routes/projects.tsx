            ...
            >
              ...
              {p.live && (
                <a
                  ...
                  className="absolute inset-0 grid place-items-center bg-foreground/40 opacity-0 backdrop-blur-sm transition-opacity duration-300 group-hover:opacity-100"
                >
